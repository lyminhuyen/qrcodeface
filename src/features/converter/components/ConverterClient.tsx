...
import { useConverter } from '@/features/converter/client/useConverter';
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800/50 rounded-xl p-6 mb-6 shadow-lg border border-gray-200 dark:border-gray-700">
            ...
            <input
              ...
              disabled={loading}
              className="block w-full text-sm text-gray-600 dark:text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-purple-600 file:text-white hover:file:bg-purple-700 file:cursor-pointer file:disabled:opacity-50"
            />
          </div>
          ...
          <div className="bg-white dark:bg-gray-800/50 rounded-xl p-6 mb-6 shadow-lg border border-gray-200 dark:border-gray-700">
            ...
            <div className="flex gap-2">
              <input
                ...
                disabled={loading}
                className="flex-1 px-4 py-2 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent disabled:opacity-50"
              />
              <button
